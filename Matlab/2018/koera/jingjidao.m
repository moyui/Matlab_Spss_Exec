%以下参数记得调整！！！
cd = 785;%城市destnation的节点数
rd = 481;%乡村destionation的节点数
rs = 594;%乡村supercharge的节点数
xv=[127.01 126.35 126.39 126.4 126.65 126.91 127.28 127.74 127.84 127.53 127.60 127.01];%区域包围点经度值(注意首尾相连)
yv=[38.28 37.77 37.59 37.4 37.1 36.92 36.91 37.23 37.55 37.65 37.94 38.28];%区域包围点纬度值(同上)
