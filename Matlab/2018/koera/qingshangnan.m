%以下参数记得调整！！！
cd = 212;%城市destnation的节点数
rd = 130;%乡村destionation的节点数
rs = 160;%乡村supercharge的节点数
xv=[129.31 128.36 127.87 127.57 128.04 128.73 128.81 129.11 129.31];%区域包围点经度值(注意首尾相连)
yv=[35.34 35.61 35.91 35.30 34.71 34.79 35.09 35.11 35.34];%区域包围点纬度值(同上)
%以下是各个城市，农村，中点坐标注意农村与中点要一一对应
city={[129.04 35.10],[128.38 35.14],[128.53 35.13],[128.06 35.10],[128.59 35.17],[128.37 34.52],[128.44 35.30]};
rural={[128.24 35.16],[127.52 35.35],[128.43 34.43],[128.09 35.33],[127.54 35.28],[128.15 35.19]};
middle={[128.14 35.12],[128.00 35.25],[128.28 34.55],[128.08 35.21],[127.54 35.20],[128.11 35.15]};
showCX=[129.04 128.38 128.53 128.06 128.59 128.37 128.44]
showCY=[35.10 35.14 35.13 35.10 35.17 34.52 35.30]
showRX=[128.24 127.52 128.43 128.09 127.54 128.15];
showRY=[35.16 35.35 34.43 35.33 35.28 35.19];
%-----------
es = 12757;%区域最左边点的经度
ed = 12931;%区域最右边点的经度
ns = 3479;%区域最下边点的纬度
