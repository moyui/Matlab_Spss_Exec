%以下参数记得调整！！！
cd = 106;%城市destnation的节点数
rd = 65;%乡村destionation的节点数
rs = 80;%乡村supercharge的节点数
xv=[126.83 125.90 125.87 126.18 126.85 127.82 127.80 127.48 126.83];%区域包围点经度值(注意首尾相连)
yv=[35.51 35.35 34.61 34.35 34.29 34.49 35.04 35.39 35.51];%区域包围点纬度值(同上)
%以下是各个城市，农村，中点坐标注意农村与中点要一一对应
city={[126.51 35.09],[127.39 34.45],[126.23 34.48],[127.29 34.57],[127.41 34.56],[126.42 35.00]};
rural={[126.35 34.34],[127.17 34.36],[126.41 34.48],[127.04 34.46],[126.54 34.40],[126.06 34.49],[126.15 34.29],[127.27 35.12]};
middle={[126.28 34.41],[127.27 34.41],[126.41 34.54],[127.17 34.51],[126.47 34.50],[126.14 34.48],[126.19 34.39],[127.28 35.04]};
showCX=[126.51 127.39 126.23 127.29 127.41 126.42];
showCY=[35.09 34.45 34.48 34.57 34.56 35.00];
showRX=[126.35 127.17 126.41 127.04 126.54 126.06 126.15 127.27];
showRY=[34.34 34.36 34.48 34.46 34.40 34.49 34.29 35.12];
%-----------
es = 12587;%区域最左边点的经度
ed = 12782;%区域最右边点的经度
ns = 3429;%区域最下边点的纬度
